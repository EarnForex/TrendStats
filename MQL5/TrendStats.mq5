...
#property description "Results are saved to files (written as .csv to \\MQL5\\Files\\)."
...
void OnStart()
{
    ...
    for (int i = 0; i < symbols_count; i++)
    {
        for (int j = 0; j < timeframes_count; j++)
        {
            ...
            Spikiness_mean[i * timeframes_count + j] = TS.Spikiness_mean;
            Spikiness_median[i * timeframes_count + j] = TS.Spikiness_median;
